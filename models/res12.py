...
class ResNet(nn.Module):
    ...
    def __init__(self, keep_prob=1.0, avg_pool=True, drop_rate=0.1, dropblock_size=5, mtl=False):
        self.inplanes = 3
    ...
    def _make_layer(self, block, planes, stride=1, drop_rate=0.0, drop_block=False, block_size=1):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, drop_rate, drop_block, block_size, mtl=self.mtl))
...
def Res12(keep_prob=1.0, avg_pool=False, **kwargs):
    ...
    """
    model = ResNet(keep_prob=keep_prob, avg_pool=avg_pool, **kwargs)
    return model
